...
public class RegisterRequestDto {
    @Pattern(
            regexp = "^[a-zA-Z0-9\\-_|°¿?%]+$",
            message = "Only letters, numbers, hyphens (-), underscores (_), pipes (|), degree signs (°), question marks (¿?), and percent signs (%) are allowed in the field 'username'."
    )
    ...
    @Size(min=8, message = "password field needs 8 min. characters.")
